...
public class server {
    public static void main(String[] args) throws IOException
    {
       ...
       while(true)
       {
        try
        {
            ServerSocket sersock = new ServerSocket(3007);
            sock = sersock.accept();  

            System.out.println("***********************************************************");
            System.out.println("\t CLOUD SERVER FRAMEWORK - Partial Audit");
            System.out.println("***********************************************************");
            ...
            System.out.println("Sending all Murmur Hash Values to TPA framework");
            System.out.println("***********************************************************");
